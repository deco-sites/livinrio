...
function Accordion(
  ...
  return (
    ...
    >
      <>
        <div
          className={`cursor-pointer flex items-center pl-5 exl:py-8 h-[48px] exl:hover:bg-[#BABD8D] rounded-md font-sfprodisplay font-medium ${open
            ? "border-b border-solid border-[#61616133] rounded-b-[0] mb-0 bg-[#BABD8D80]"
            : "mb-4 bg-[#BABD8D80]"
            }`}
        ...
        <div
          className={`bg-[#BABD8D80] exl:hover:bg-[#BABD8D] exl:max-h-[598px]`}
        >
          <div
                  ...
                  <a href={cards.href}>
                    <div class="hidden cursor-pointer exl:flex exl:flex-col exl:max-w-[306px] exl:min-w-[306px] exl:mr-4 bg-white mb-4 rounded-lg exl:hover:shadow-md">
                      <div class="relative">
                        ...
                        {cards.ad ? <span class="absolute top-3 right-[14px] flex items-center font-sfprodisplay text-white text-[8px] py-[3px] px-[7px] exl:py-[6px] exl:px-3 exl:max-h-[26px] exl:text-xs font-normal bg-[#252D29] rounded-lg">Ad</span> : ''}
                      </div>
                      <div class="flex flex-col pl-4 pr-3 pt-3 pb-4">
                        ...
                        <div class="flex items-center justify-between">
                          ...
                          <Icon id="ChevronRightCardDesk" width={24} height={24} />
                        </div>
                      </div>
                    </div>
                  </a>
                ...
                <div class="flex exl:flex-col exl:max-w-[306px] exl:min-w-[306px] exl:mr-4 bg-white mb-4 rounded-lg">
                  ...
                  <div class="flex flex-col pl-4 pr-3 pt-3 pb-4">
                    <div class="flex items-center justify-between">
                      ...
                      <Icon id="ChevronRightCardMobile" width={14} height={14} />
                    </div>

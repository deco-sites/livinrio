...
export default function GetInTouch({ formTitle, formSubTitle }: form) {
    ...
    const handleFormSubmit = () => {
        ...
        const apiKey = 'patYrFQxcbEfaTfQ3.f92a02ac3ffac677489af2588c1006875809c5b32ae685868709567c847e7e5a';
    ...
    return (
        <div class="">
            <div class="mb-8">
                <h1 class="text-[#252D29] text-2xl font-extrabold text-center mb-3">
                    {formTitle}
                </h1>
                <p class="text-[#616161] text-center text-xs">
                    {formSubTitle}
                </p>
            </div>
            ...
            <div class="px-4 flex flex-col justify-center items-center">
                <form class="w-full flex flex-col items-center">
                    <div class="w-full max-w-[400px] flex flex-col items-center">
                        <label class="w-full text-xs text-[#252D29]">Your complete name</label>
                        <input
                ...
                <button class="flex items-center justify-center max-h-[40px] max-w-[400px] mt-8 text-white text-center bg-[#343F39] rounded-lg w-full py-4"

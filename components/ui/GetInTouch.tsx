  ...
  return (
    <div class="">
      <div class="mb-8 md0:mb-10">
        ...
        <p class="text-[#616161] font-sfprodisplay font-normal text-center text-xs md0:text-[14px] exl:text-[18px] md0:leading-[18px]">
          {formSubTitle}
        </p>
      </div>
      ...
      <div class="px-4 flex flex-col justify-center items-center">
        ...
        >
          <div class="w-full max-w-[400px] flex flex-col items-center">
            <label
              for="fullname"
              class="font-sfprodisplay font-normal w-full text-xs md0:text-[14px] exl:text-[18px] leading-[20px] text-[#252D29]"
            >
              Your complete name
            </label>
            <input

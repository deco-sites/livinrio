        ...
        <div class="">
            <div class="hidden md0:block max-w-[664px] lg:max-w-[656px] mx-auto pt-[56px]">
                <div class="flex flex-col">
                    <span class="text-center mb-8 text-[#616161] text-base">Some of our partners</span>
            ...
            <div class="lg:hidden max-w-[664px] lg:max-w-[656px] md0:mx-auto pb-3 mt-[52px] flex flex-col mx-4">
                ...
                <span class="text-[#252D29] text-xs md0:mt-2 mb-4">Privacy Policy</span>

                <div class="flex items-center justify-between">
                    <span class="text-[#252D29] text-xs">Cookies</span>
                    <div class="flex flex-col md0:flex-row">
                        <span class="text-[#252D29] text-[10px]">© 2023 Copyright.</span>
                        {" "}
                        <span class="text-[#252D29] text-[10px]">All Rights Reserved.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden lg:flex mx-[80px] mt-[113px] mb-6">
                <div class="flex items-center justify-between w-full">
                    <span class="text-[#252D29] text-[10px]">© 2023 Copyright. All Rights Reserved.</span>

                    <div class="flex justify-between items-center">
                        <span class="text-[#252D29] text-sm">Terms</span>
                        <span class="text-[#252D29] text-sm mx-9">Privacy Policy</span>
                        <span class="text-[#252D29] text-sm">Cookies</span>
                    </div>

                    <div class="flex items-center">
                        <span class="text-[#252D29] text-xs mr-4">Powered by</span>
                        {" "}

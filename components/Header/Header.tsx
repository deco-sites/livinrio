                        ...
                        <div class="flex flex-col md0:flex-row justify-center gap-4 bg-[#292302] rounded-t-3xl md0:rounded-xl px-4 w-full md0:px-[46px] md0:py-4 md0:h-[268px] lg:h-[371px] exl:h-[452px] md0:border-[12px] md0:border-[#616161]">
                            ...
                            {items.map((find) => (
                                <a href={find.redirectTo}>
                                    <div
                                        className="searchContent h-full flex md0:flex-col md0:min-w-[194px] lg:min-w-[245px] exl:min-w-[306px] justify-center items-center rounded-2xl min-h-[103px] pr-6 pl-10 md0:p-0"
                                    >
                                        <Image
                                            src={find.image}
                                            loading="lazy"
...
export default function Header(
    { background, topText, mainText, search }: HeaderProps,
) {
